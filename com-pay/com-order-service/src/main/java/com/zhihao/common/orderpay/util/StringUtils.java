...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
	...
	/**
	 * camel4underline(大写转下划线的算法:驼峰转下划线)
	 *
	 * @author 软件部-Administrator
	 * @date 2015年4月14日 下午2:19:50
	 */
	...
	/**
	 * underlineTocamel(大写转下划线的算法:下划线转驼峰)
	 *
	 * @author 软件部-Administrator
	 * @date 2015年4月14日 下午2:19:50
	 */
	public static String underlineTocamel(String param) {
		return replaceUnderlineAndfirstToUpper(param, "_");
	}
